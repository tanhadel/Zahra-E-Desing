...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${isScrolled ? 'bg-white/98 shadow-lg backdrop-blur-md' : 'bg-white/85 backdrop-blur-sm'}`}>
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          {/* Left - Navigation */}
          <nav className="hidden lg:flex items-center space-x-8">
            <Link href="/" className="text-gray-900 hover:text-primary-500 transition-colors text-xs font-semibold tracking-widest uppercase">
              HOMEPAGE
            </Link>
            <div className="relative group">
              <button className="text-gray-900 hover:text-primary-500 transition-colors text-xs font-semibold tracking-widest flex items-center gap-1 uppercase">
                SERVICES
            ...
            <Link href="/contact" className="text-gray-900 hover:text-primary-500 transition-colors text-xs font-semibold tracking-widest uppercase">
              CONTACT US
            </Link>
            <div className="relative group">
              <button className="text-gray-900 hover:text-primary-500 transition-colors text-xs font-semibold tracking-widest flex items-center gap-1 uppercase">
              ...
              <div className="absolute top-full left-0 mt-2 w-56 bg-white shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100">
                ...
                <Link href="/blog/post" className="block px-6 py-3 text-gray-800 hover:bg-primary-50 hover:text-primary-600 text-xs font-medium tracking-wider uppercase border-b border-gray-100 transition-colors">
                  SINGLE POST
                </Link>
                <Link href="/404" className="block px-6 py-3 text-gray-800 hover:bg-primary-50 hover:text-primary-600 text-xs font-medium tracking-wider uppercase transition-colors">
                  ERROR 404
                </Link>
              </div>
            </div>
